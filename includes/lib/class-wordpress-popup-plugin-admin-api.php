 ...
 * Admin API class.
 */
class WordPress_Popup_Plugin_Admin_API {
		...
		switch ( $field['type'] ) {
			...
			case 'checkbox_multi':
				foreach ( $field['options'] as $k => $v ) {
					...
					$html .= '<p><label for="' . sanitize_text_field( $field['id'] . '_' . $k ) . '" class="checkbox_multi"><input type="checkbox" ' . checked( $checked, true, false ) . ' name="' . sanitize_text_field( $option_name ) . '[]" value="' . sanitize_text_field( $k ) . '" id="' . sanitize_text_field( $field['id'] . '_' . $k ) . '" /> ' . $v . '</label></p> ';
				}
				break;
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'wordpress-popup-plugin' ) . '" data-uploader_button_text="' . __( 'Use image', 'wordpress-popup-plugin' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'wordpress-popup-plugin' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'wordpress-popup-plugin' ) . '" />' . "\n";
